 ...
 */
public class BeatOneClassifier extends BaseClassifier {
     ...
     * @param activity
     */
    BeatOneClassifier(Activity activity,String modelFilePath,String dataFilePath,int batchSize,boolean nnApi) throws IOException {

 ...
 */
public class BeatGroup2Classifier extends BaseClassifier {
     ...
     * @param activity
     */
    BeatGroup2Classifier(Activity activity,String modelFilePath,String dataFilePath,int batchSize,boolean nnApi) throws IOException {
    ...
    protected String getModelPath() {
        ...
        //return "tflite_4leader_13class_0817_2.tflite";

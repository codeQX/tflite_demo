 ...
 */
public class MnistBatchClassifier extends BaseClassifier {
     ...
     * @param activity
     */
    MnistBatchClassifier(Activity activity,String modelFilePath,String dataFilePath,int batchSize,boolean nnApi) throws IOException {
    ...
    protected String getModelPath() {
        ...
        //return "mnist_2d_batch10_0808.tflite";

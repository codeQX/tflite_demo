...
public class ImageClassifierFloatInception extends ImageClassifier {
   ...
   * @param activity
   */
  public ImageClassifierFloatInception(Activity activity,String modelFilePath,String dataFilePath,int batchSize) throws IOException {
    super(activity,modelFilePath,dataFilePath,batchSize);
  ...
  protected String getModelPath() {
    ...
    //return "converted_model_mobilev1.tflite";
	//return "freeze_model_flat_mnist.tflite";
    //return "freeze_model_mnist.tflite";
    //return "inception_v3_my.tflite";
